...
def crud_mp(request):
    ...
    return render(request, 'inventary/crud_mp.html', {'mps': mps})
...
def ingresar_mp(request):
    if request.method == 'POST':
        ...
        form = MpForm()
    return render(request, 'inventary/ingresar_mp.html', {'form': form})
...
def editar_mp(request, adtv_id):
    ...
    return render(request, 'inventary/editar_mp.html', {'form': form})
...
def eliminar_mp(request, adtv_id):
    ...
    return render(request, 'inventary/eliminar_mp.html', {'aditivo': aditivo})

def listar_mp(request):
    mps = InfoAditivo.objects.all()
    return render(request, 'inventary/listar_mp.html', {'mps': mps}) 
...
def listar_in(request):
    insus = Insumo.objects.all()
    return render(request, 'inventary/listar_insumo.html', {'insus': insus})
...
def ingresar_in(request):
    if request.method == 'POST':
        ...
        form = InForm()
    return render(request, 'inventary/ingresar_insumo.html', {'form': form})
...
def eliminar_in(request, insumo_id):
    ...
    return render(request, 'inventary/eliminar_insumo.html', {'insumo': insumo})
...
def editar_in(request, insumo_id):
    ...
    return render(request, 'inventary/editar_insumo.html', {'form': form})
